(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Shift_Edit_js"],{
...
//     const [paidAt, setPaidAt] = useState(shift ? new Date(shift.paid_at) : '');
//
//
//
//     console.log(shift)
...
//                                                 <Select
//                                                     value={shift ? {value: shift.status, label: STATUSES[shift.status]}  : options.statuses.filter(st => st?.value === status)}
//                                                     onChange={(e) => {
//                                                         setStatus(e.value)
//                                                     }}
